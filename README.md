...
**Live site:** [shanghai-connect.com](https://shanghai-connect.com)
...
- [sitemap.xml](sitemap.xml) — generated by [scripts/generate_sitemap.py](scripts/generate_sitemap.py), and [robots.txt](robots.txt)
- [vercel.json](vercel.json) — clean URLs, legacy `.html` redirects, cache and security headers
...
3. Set up analytics and Google Search Console
