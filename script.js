...
const copy = {
  en: {
    ...
    footerTagline:
      "Shanghai Connect is a practical guide for newcomers, expats, students, travellers, and foreign residents navigating life in Shanghai.",
    footerExplore: "Explore",
    footerSupport: "Support",
    footerLegal: "Legal",
    footerMoving: "Moving to Shanghai",
    footerLiving: "Living in Shanghai",
    footerApps: "Essential Apps",
    footerVpn: "VPN Guide",
    footerMetro: "Metro Guide",
    footerContact: "Contact",
    footerSuggest: "Suggest a Guide",
    footerNewsletter: "Newsletter",
    footerPrivacy: "Privacy Policy",
    footerDisclaimer: "Disclaimer",
    footerAffiliate: "Affiliate Disclosure",
    footerCopyright: "© 2026 Shanghai Connect. All rights reserved.",
  ...
  zh: {
    ...
    footerTagline:
      "Shanghai Connect 是一份实用指南，帮助新来者、外籍人士、学生、旅行者和外国居民更好地适应上海生活。",
    footerExplore: "探索",
    footerSupport: "支持",
    footerLegal: "法律",
    footerMoving: "搬来上海",
    ...
    footerContact: "联系我们",
    footerSuggest: "建议新指南",
    footerNewsletter: "邮件订阅",
    footerPrivacy: "隐私政策",
    footerDisclaimer: "免责声明",
    footerAffiliate: "联盟推广披露",
    footerCopyright: "© 2026 Shanghai Connect 版权所有。",
    relatedEyebrow: "相关指南",
